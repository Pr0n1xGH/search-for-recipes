...
async function getReceptions() {
    ...
    fetch('http://127.0.0.1:8000/api/endpoint/en', {
        method: 'POST',
        headers: {
        ...
        .then((data) => {
            ...
            for (item in data) {
                ...
                .then((recepts) => {
                    ...
                    const data = { title: recepts.title, summary: recepts.summary.replace(/(<([^>]+)>)/ig, '') };
                    ...
                    .then(result => {
                        ...
                        recept.innerHTML = `
                            ...
                            <h2 class='title_recept'>${result.new_title}</h2>
                            <p class='summary'>${result.new_summary}</p>
